...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options) {
            ...
            $.each(options, function (key, value) {/*多了些参数配置*/
                switch (key) {
                    case 'minFileCount':
                    case 'maxFileCount':
                    case 'minFileSize':
        ...
        _parseError: function (operation, jqXHR, errorThrown, fileName) {
            ...
            var self = this, errMsg = '', dot = errMsg.slice(-1) === '.' ? '' : '.', // modified by xuzhenyi@2017-11-20 change errMsg = $.trim(errorThrown + '') to errMsg = '' to hide the technical tern
